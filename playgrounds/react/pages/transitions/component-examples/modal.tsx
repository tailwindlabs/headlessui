        ...
        <div className="inline-block p-12">
          <span className="mt-3 flex w-full rounded-md shadow-xs sm:mt-0 sm:w-auto">
            <button
              onClick={toggle}
              type="button"
              className="focus:shadow-outline-blue inline-flex w-full justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-base font-medium leading-6 text-gray-700 shadow-xs transition duration-150 ease-in-out hover:text-gray-500 focus:border-blue-300 focus:outline-hidden sm:text-sm sm:leading-5"
            >
              Show modal
            </button>
          </span>
          ...
          >
            ...
            <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
              <span className="flex w-full rounded-md shadow-xs sm:ml-3 sm:w-auto">
                <button
                  type="button"
                  className="focus:shadow-outline-red inline-flex w-full justify-center rounded-md border border-transparent bg-red-600 px-4 py-2 text-base font-medium leading-6 text-white shadow-xs transition duration-150 ease-in-out hover:bg-red-500 focus:border-red-700 focus:outline-hidden sm:text-sm sm:leading-5"
                >
                  Deactivate
                </button>
              </span>
