          ...
          <Listbox value={activePersons} onChange={setActivePersons} name="people" multiple>
            ...
            <div className="relative">
              <span className="inline-block w-full rounded-md shadow-xs">
                <Listbox.Button className="focus:shadow-outline-blue relative w-full cursor-default rounded-md border border-gray-300 bg-white py-2 pl-2 pr-10 text-left transition duration-150 ease-in-out focus:border-blue-300 focus:outline-hidden sm:text-sm sm:leading-5">
