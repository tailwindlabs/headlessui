    ...
    <div class="w-full max-w-4xl">
      <div class="space-y-1">
        <form @submit="onSubmit">
          <Combobox v-model="activePersons" name="people" multiple>
            ...
            <div class="relative">
              <span class="inline-block w-full rounded-md shadow-xs">
                <div
                  class="relative w-full cursor-default rounded-md border border-gray-300 bg-white py-2 pl-2 pr-10 text-left transition duration-150 ease-in-out focus-within:border-blue-700 focus-within:outline-hidden focus-within:ring-1 focus-within:ring-blue-700 sm:text-sm sm:leading-5"
                >
              ...
              <div class="absolute mt-1 w-full rounded-md bg-white shadow-lg">
                ...
                >
                  ...
                  >
                    <li
                      class="relative cursor-default select-none py-2 pl-3 pr-9 focus:outline-hidden"
          ...
          <button
            class="mt-2 inline-flex items-center rounded-sm border border-gray-300 bg-white px-2.5 py-1.5 text-xs font-medium text-gray-700 shadow-xs hover:bg-gray-50 focus:outline-hidden focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
          >
            Submit
          </button>
        </form>
