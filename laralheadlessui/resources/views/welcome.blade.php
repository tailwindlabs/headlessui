...
@section('content')
    ...
    $components = [
        ...
        ['Spinner', '<x-spinner />'],
        ['Spinner (small)', '<x-spinner size="sm" />'],
        ['Spinner (medium)', '<x-spinner size="md" />'],
        ['Spinner (large)', '<x-spinner size="lg" />'],
        ['Collapse', '<x-collapse><div class="p-2">Contenu repliable</div></x-collapse>'],
        ['Collapse (ouvert)', '<x-collapse open><div class="p-2">Contenu ouvert</div></x-collapse>'],
        ['Collapse (alwaysOpen)', '<x-collapse alwaysOpen><div class="p-2">Toujours ouvert</div></x-collapse>'],
        ['Collapse (transition rapide)', '<x-collapse transition="fast"><div class="p-2">Transition rapide</div></x-collapse>'],
        ['Collapse (transition lente)', '<x-collapse transition="slow"><div class="p-2">Transition lente</div></x-collapse>'],
